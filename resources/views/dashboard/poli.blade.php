            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-heading">
                        ...
                        <p class="fs-18">
                            {{__('Make payment to our POLi Merchant Account.')}}
                        </p>
                                    ...
                                    <div class="col-xl-7">
                                        <div class="credit-card">
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    <label class="text-2">
                                                        {{__('Bank Account (POLi)')}}
                                                    </label>
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Bank Account (POLi)')}}" value="{{ old('bank_account_id') }}" name="bank_account_id" />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    <label class="text-2">
                                                        {{__('Your Name or Email')}}
                                                    </label>
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Your Name or Email')}}" value="{{ old('email') }}" name="ermail" />
                                                    </div>
                                                </fieldset>
                                            </div>
