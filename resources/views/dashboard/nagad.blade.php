                ...
                <div class="col-12">
                    <div class="page-heading">
                        <h2 class="fw-9 wow fadeInUp" data-wow-delay="0s">{{__('Deposit')}}</h2>
                                                ...
                                                <p class="fs-18">
                                                    {{__('Make payment to our Nagad merchant number.')}}
                                                </p>
                                        ...
                                        <div class="currency-box number_pay_box mt--10">
                                            ...
                                            <div class="currency-box-content">
                                                ...
                                                <div class="wallet-balance">
                                                    ...
                                                    <div class="mb-4">
                                                        <label for="bkash_number" class="text-2">{{__('Nagad Merchant This Number 👇')}}</label>
                                                    </div>
                                                    <div class="content-input mt-5">
                                                        <input type="text" id="usd4" class="currency-input"
                                                            value="{{ get_option('nagad_number', '') }}" readonly />
                                                        <span class="currency">
