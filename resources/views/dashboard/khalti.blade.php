            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-heading">
                        ...
                        <p class="fs-18">
                            {{__('Make payment to our Khalti Merchant')}}
                        </p>
                                        ...
                                        <div class="credit-card">
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    ...
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Enter khalti wallet ID')}}" value="{{ old('esewa_number') }}" name="esewa_wallet_id" />
                                                    </div>
                                                </fieldset>
                                            </div>
