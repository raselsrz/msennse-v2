            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-heading">
                        ...
                        <p class="fs-18">
                            {{__('Make payment to our eSewa Merchant')}}
                        </p>
                                        ...
                                        <div class="currency-box number_pay_box mt--10">
                                            <div class="title mb-2">
                                                <h5 class="credit-card-title">
                                                    {{__('eSewa Merchant Payment Method')}}
                                                </h5>
                                            </div>
                                        ...
                                        <div class="credit-card">
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    ...
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Enter eSewa wallet id')}}" value="{{ old('esewa_number') }}" name="esewa_wallet_id" />
                                                    </div>
                                                </fieldset>
                                            </div>
