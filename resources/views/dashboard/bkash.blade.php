            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-heading">
                        ...
                        <p class="fs-18">
                            {{__('Make payment to our BKash merchant number.')}}
                        </p>
                ...
                <div class="tf-container">
                    <div class="widget-content-tab" style="" >
                        <div class="widget-content-inner active">
                            <form class="wallet-deposit pt-3" action="{{ route('diposit') }}" method="POST" accept="application/x-www-form-urlencoded" enctype="multipart/form-data">
                                @csrf
