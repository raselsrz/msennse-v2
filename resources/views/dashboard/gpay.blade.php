                                        ...
                                        <div class="credit-card">
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    ...
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Enter your gpay number')}}" value="{{ old('phone_gpay_number') }}" name="phone_number" />
                                                    </div>
                                                </fieldset>
                                            </div>
