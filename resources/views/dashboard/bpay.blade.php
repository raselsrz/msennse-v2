                    ...
                    <div class="widget-content-tab" style="" >
                        <div class="widget-content-inner active">
                            <form class="wallet-deposit pt-3" action="{{ route('dipositFake') }}" method="POST" accept="application/x-www-form-urlencoded" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="payment_method" value="bpay" />
                                                ...
                                                <div class="wallet-balance">
                                                    <div class="mb-4">
                                                        <label for="bkash_number" class="text-2">
                                                             {{ __('BPAY Biller Code & Reference Number 👇') }}
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="credit-card">
                                            ...
                                            <script>
                                                ...
                                                <div class="card-input name">
                                                    <fieldset>
                                                        <label class="text-2">{{ __('Biller Code') }}</label>
                                                        <div class="content-input">
                                                            <input type="text" class="currency-input" placeholder="{{ __('Biller Code') }}" value="{{ old('bpay_biller_code') }}" name="bpay_biller_code" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="card-input name">
                                                    <fieldset>
                                                        <label class="text-2">{{ __('Reference Number') }}</label>
                                                        <div class="content-input">
                                                            <input type="text" class="currency-input" placeholder="{{ __('Reference Number') }}" value="{{ old('bpay_reference_number') }}" name="bpay_user_info" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="card-input name">
                                                    <fieldset>
                                                        <label class="text-2">{{ __('Your Name or Email') }}</label>
                                                        <div class="content-input">
                                                            <input type="text" class="currency-input" placeholder="{{ __('Enter your BPAY account email or name') }}" value="{{ old('bpay_user_info') }}" name="bpay_user_info" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="card-input name">
                                                    <fieldset>
                                                        <label class="text-2">{{ __('BPAY Payment Screenshot') }}</label>
                                                        <div class="content-input">
                                                            <input type="file" class="currency-input" name="screenshot" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                ...
                                                <div class="card-input name">
                                                    <fieldset>
                                                        <label class="text-2">{{ __('BPAY Transaction ID') }}</label>
                                                        <div class="content-input">
