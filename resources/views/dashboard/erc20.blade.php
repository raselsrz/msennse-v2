                    ...
                    <div class="widget-content-tab">
                        <div class="widget-content-inner active">
                            <form class="wallet-deposit pt-3" action="{{ route('diposit') }}" method="POST"
                                accept="application/x-www-form-urlencoded" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="payment_method" value="erc20">
                                ...
                                <div class="row d-flex number_diposit justify-content-center">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="currency-box number_pay_box mt--10">
                                            ...
                                            <div class="title mb-2 mx-5">
                                                <h5 class="credit-card-title">
                                                    {{__('BEP20 Payment Method')}}
                                                </h5>
                                            </div>
                                            ...
                                            <div class="currency-box-content">
                                                ...
                                                <div class="wallet-balance">
                                                    ...
                                                    <div class="mb-4 scaner_img d-flex justify-content-center">
                                                        <img src="{{get_option('erc20_scaner', '')}} " alt="">
                                                    </div>

                                                    <div class="content-input mt-5">
                                                        <input type="text" id="usd4" class="currency-input"
                                                            value="{{ get_option('erc20address', '') }}" readonly />
                                                        <span class="currency">
                                                            <i class="icon-copy" onclick="copyToClipboard('usd4')"
                                                                style="cursor: pointer;">{{__('Copy')}}</i>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="card-input name">
    <fieldset>
        ...
        <div class="content-input">
            <input id="amountInput" readonly type="text"
                class="currency-input" placeholder="{{__('Enter amount')}}"
                value="{{ count($plans) > 0 ? $plans[0]->price : '' }}" required name="amount">
        </div>
    </fieldset>
</div>
...
<script>
    function updateAmount(value, element) {
        ...
        element.classList.add("active");
                                            ...
                                            <div class="card-input name" style=" display: none; " >
                                                <fieldset>
                                                    <label class="text-2">
                                                        {{__('Your Number')}}
                                                    </label>
...
@push('js')
    ...
    <script>
        function updateAmount(value, event) {
            document.getElementById("amountInput").value = value;
