                                    ...
                                    <div class="col-xl-7">
                                        <div class="credit-card">
                                                    ...
                                                    <li class="item-title1 {{ $index === 0 ? 'active' : '' }}" onclick="updateAmount({{ $plan->price }}, this)">
                                                        <div class="plan-card p-4 rounded-xl bg-[#1a1737] text-white space-y-2">
                                                            ...
                                                            <div class="text-lg font-semibold text-right">
                                                              <p>
                                                                 रु {{ convertCurrencyNepal($plan->price)}}
                                                              </p>
                                                            </div>
                                                        </div>
                                                    </li>
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    <label class="text-2">
                                                        {{__('IME Pay Wallet ID')}}
                                                    </label>
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Enter your IME Pay Wallet ID')}}" value="{{ old('wallet_id') }}" name="phone_number" />
                                                    </div>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="card-input name">
                                                <fieldset>
                                                    <label class="text-2">
                                                        {{__('Your IME Pay Number')}}
                                                    </label>
                                                    <div class="content-input">
                                                        <input type="text" class="currency-input" placeholder="{{__('Enter your ime pay number')}}" value="{{ old('phone_number') }}" name="phone_number" />
                                                    </div>
                                                </fieldset>
                                            </div>
