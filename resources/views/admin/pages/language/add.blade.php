            ...
            <div class="card-body">
                <form action="{{route('admin.languages.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="language" class="form-control" id="title" required value="{{old('name')}}">
                    </div>

                    {{-- iso_code --}}
                    <div class="mb-3">
                        <label for="iso_code" class="form-label">ISO Code</label>
                        <input type="text" name="iso_code" class="form-control" id="iso_code" required value="{{old('iso_code')}}">
                    </div>
