            ...
            <div class="card-body">
                <form action="{{route('admin.categories.update', [
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control" id="title" value="{{$category->name}}" required>
                    </div>

                    <div class="mb-3">
                        <label for="content" class="form-label">Content:</label>
                        <textarea class="form-control" name="content" id="content"  rows="4" required>{{$category->description}}</textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <label for="img" class="form-label">Or Input Image Url:</label>
                         <input type="url" name="img" class="form-control" id="img" value="{{get_field('cat_img','category',$category->id,'')}}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="category" name="category" required>
                            ...
                            foreach($categories as $categoryX){
                                ?>
                            <option value="<?php echo $categoryX->id;?>" 
                                {{
                                    $categoryX->id == $category->parent ? 'selected' : ''
                                
                                }}
                                ><?php echo $categoryX->name;?></option>
                            <?php }?>
                        </select>
                    </div>
