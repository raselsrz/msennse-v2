                                ...
                                <tbody>
                                    ...
                                    <tr> 
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a href="{{route('admin.message.view',['id'=>$movie->id])}}" class="btn btn-sm btn-neutral"><i class="bi bi-eye"></i></a>
                                            <a href="{{route('admin.message.delete',['id'=>$movie->id])}}" onclick="return confirm('Are you sure you want to delete ?')" class="btn btn-sm btn-neutral"> <i class="bi bi-trash"></i></a>
