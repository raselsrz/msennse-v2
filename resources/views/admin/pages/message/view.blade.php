            ...
            <div class="card-body">
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text"  readonly name="post_title" class="form-control" id="title" 
                      value="{{get_field('email','contact', $movie->id, '')}}" required> 
                  </div>


                    <div class="mb-3">
                        <label for="content" class="form-label">Content:</label>
                        <textarea style=" height: 370px; " class="form-control" readonly name="post_content" id="content"  rows="4" required>{{$movie->post_content}}</textarea>
                    </div>
